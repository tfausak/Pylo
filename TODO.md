...
- [ ] **Deduplicate `toJSON` Accessory Information boilerplate** — The Accessory Information service JSON is copy-pasted across all 5 accessory classes. Extract to a shared helper or protocol extension.
...
- [ ] **Fix logger subsystem** — All loggers use `"com.example.hap"`. Should use `"me.fausak.taylor.Pylo"`.
